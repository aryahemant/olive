...
class Checkoutdetail extends Component {
  ...
  handleApartmentType = (e) => {
    ...
    console.log("fas gya", JSON.parse(localStorage.getItem("property_amenity_pre")));
    ...
    if (
      ...
      localStorage.setItem("property_amenity", JSON.stringify(JSON.parse(localStorage.getItem("property_amenity_sup"))));
      ...
      localStorage.setItem("cutprice_sup_pre", localStorage.getItem("cutprice_pre"));
    } else if (
      localStorage.getItem("apartmentTitle") === "furnished" &&
      ...
      localStorage.setItem("cutprice", localStorage.getItem("cutprice_sup_free"));
      ...
      localStorage.setItem("cutprice_sup_pre_free", localStorage.getItem("cutprice_pre_free"));
    } else if (
      ...
      localStorage.setItem("cutprice", localStorage.getItem("cutprice_sup_pre"));
      localStorage.setItem("price_type", "pnrefundable_price");
      localStorage.setItem("property_amenity", JSON.stringify(JSON.parse(localStorage.getItem("property_amenity_pre"))));
      this.setState(
        {
      ...
      localStorage.setItem("cutprice", localStorage.getItem("cutprice_sup_pre_free"));
      localStorage.setItem("property_amenity", JSON.stringify(JSON.parse(localStorage.getItem("property_amenity_pre"))));
      this.setState(
        {
